...
- [ ] Init git repo
- [ ] Create package.json, tsconfig.json, eslint.config.mjs, jest.config.js, .gitignore, index.js
...
- [ ] Write failing tests for validators (CNPJ checksum, CEP format)
- [ ] Implement validators
- [ ] Write failing tests for fallback logic (with fake timers)
- [ ] Implement fallback
...
- [ ] Write failing tests for CNPJ normalizer (3 providers)
- [ ] Implement normalizer
- [ ] Create CNPJ description + execute handlers
- [ ] Write tests for execute handlers
- [ ] All tests pass, commit
- **Status:** pending
- **Plan reference:** Chunk 2, Tasks 5-6

### Phase 4: CEP Resource (Tasks 7-8)
- [ ] Write failing tests for CEP normalizer (3 providers)
- [ ] Implement normalizer
- [ ] Create CEP description + execute handlers
- [ ] Write tests for execute handlers
- [ ] All tests pass, commit
- **Status:** pending
...
- [ ] Create BrasilHub.node.ts (router), .node.json (codex), .svg (icon)
- [ ] Write node metadata tests
- [ ] Build + lint + all tests pass
- [ ] Create README.md + LICENSE
- [ ] Verify dist structure
- [ ] Run @n8n/scan-community-package
- [ ] Final commit
- **Status:** pending
