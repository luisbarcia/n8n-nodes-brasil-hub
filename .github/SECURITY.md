...
Each GitHub Release includes a `.intoto.jsonl` attestation file generated by [SLSA GitHub Generator](https://github.com/slsa-framework/slsa-github-generator) (Level 3). This provides a tamper-proof record of what source code and build process produced the release artifacts.
